...
function ENT:Initialize()			
	...
	if (SERVER) then
		...
		local fog = { FogColor=col,FogStart=0,FogEnd={Outside=2500,Inside=3500},FogDensity={Outside=0.3,Inside=0.2} }
	...
	local fogcol = Color(80,80,82)
	local fogcol2 = Color(90,90,92)
	...
	-- main "eyewall" hits 
		...
		elseif SERVER then
			...
			self.Surge = self:CreateStormSurge(math.random(180,250))
	...
	-- eye passes over
		...
		elseif SERVER then
			...
			local fog = { FogColor=fogcol,FogStart=0,FogEnd={Outside=8500,Inside=10000},FogDensity={Outside=0.2,Inside=0.1} }
			gWeather:CreateFog(fog)
	...
	-- main rainbands pass, precipitation is almost past
		...
		local fog = { FogColor=fogcol2,FogStart=0,FogEnd={Outside=2500,Inside=3500},FogDensity={Outside=0.3,Inside=0.2} }
		gWeather:CreateFog(fog)
