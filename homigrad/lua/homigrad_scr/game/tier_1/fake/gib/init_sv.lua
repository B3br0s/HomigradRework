...
function Gib_Input(rag,bone,dmgInfo,player)
	...
	if dmgInfo:GetDamage() >= 1200 and dmgInfo:IsDamageType(DMG_CRUSH+DMG_VEHICLE) or rag:GetVelocity():Length() > 740 and dmgInfo:IsDamageType(DMG_CRUSH+DMG_BLAST+DMG_VEHICLE+DMG_FALL) or math.random(1,152) == 52 and dmgInfo:IsDamageType(DMG_CRUSH+DMG_BLAST+DMG_VEHICLE+DMG_FALL) then
		...
		--	if GetGlobalBool("BloodGoreEnabled") then
				...
				ParticleEffect("impact0_smoke",rag:GetPhysicsObject(a0oapidor):GetPos() / 1.02,Angle(math.random(360),math.random(360),math.random(360)))
				ParticleEffect("impact0_smoke",rag:GetPhysicsObject(a0oapidor2):GetPos() * 1.02,Angle(math.random(360),math.random(360),math.random(360)))
				ParticleEffect("impact0_smoke",rag:GetPhysicsObject(a0oapidor2):GetPos() / 1.02,Angle(math.random(360),math.random(360),math.random(360)))
				...
				ParticleEffect("impact0_smoke",rag:GetPhysicsObject(a0oapidor):GetPos() / 1.04,Angle(math.random(360),math.random(360),math.random(360)))
				ParticleEffect("impact0_smoke",rag:GetPhysicsObject(a0oapidor2):GetPos() * 1.04,Angle(math.random(360),math.random(360),math.random(360)))
				ParticleEffect("impact0_smoke",rag:GetPhysicsObject(a0oapidor2):GetPos() / 1.05,Angle(math.random(360),math.random(360),math.random(360)))
