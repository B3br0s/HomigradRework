...
SWEP.PrintName = "Стимулятор M.U.L.E"
SWEP.Author = "Homigrad"
SWEP.Instructions = "Muscule Ultra Large Exciter. Позволяет организму, долгое время переносить повышенную нагрузку. ИСПОЛЬЗОВАТЬ НЕ БОЛЕЕ 1 РАЗА."
