...
SWEP.PrintName = "Стимулятор ПНБ"
SWEP.Author = "Homigrad"
SWEP.Instructions = "Боевой стимулятор. Разработан TerraGroup Labs, с маркировкой ПНБ. Позволяет кратковременно активировать работу внутренней мускулатуры, приводя ее в состояние гипертонуса, что в свою очередь уменьшает получаемый урон."
