...
SWEP.PrintName = "Стимулятор P22"
SWEP.Author = "Homigrad"
SWEP.Instructions = "Боевой стимулятор. Разработан Terra Group Labs, с маркировкой P22. Позволяет тканям организма получать меньшие повреждения при физическом воздействии за счет пассивного включения в работу внутренней мускулатуры."
