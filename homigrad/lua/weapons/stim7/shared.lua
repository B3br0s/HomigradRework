...
SWEP.PrintName = "L1 - НорАдреналин"
SWEP.Author = "Homigrad"
SWEP.Instructions = "Стерильный одноразовый шприц с дозой препарата L1, на основе норадреналина. Используется для кратковременного увеличения силы и выносливости, а также для уменьшения ощущения боли."
