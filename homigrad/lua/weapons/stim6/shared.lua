...
SWEP.PrintName = "Стимулятор SJ12 TGLabs"
SWEP.Author = "Homigrad"
SWEP.Instructions = "Разработан для бойцов спецподразделений. Замедляет работу некоторых функций организма и они временно начинают работать с профицитом потребления энергии."
