...
CLASS.weapons = {"weapon_radio","med_band_big","medkit","painkiller","weapon_handcuffs","weapon_taser","weapon_hg_flashbang","weapon_pbat"}
CLASS.secondary_weapon = {"weapon_glockp80"}
CLASS.models = {}
...
function CLASS:VCityDMG(hitGroup,dmgInfo,rag)
