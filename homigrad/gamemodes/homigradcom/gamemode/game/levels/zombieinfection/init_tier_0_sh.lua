...
zombieinfection.green = {"Люди",Color(55,55,255),
    weapons = {"weapon_radio","weapon_hands","weapon_sog","medkit","painkiller","weapon_f1"},
    main_weapon = {"weapon_r870police","weapon_aks74u","weapon_ar15g","weapon_px4"},
    secondary_weapon = {"weapon_m9","weapon_fiveseven","weapon_hk_usps"},
    models = tdm.models
}

zombieinfection.blue = {"Люди",Color(55,55,55),
    weapons = {"weapon_radio","weapon_hands","weapon_sog","med_band_big","med_band_small","medkit","painkiller","weapon_f1","weapon_handcuffs","weapon_taser","weapon_hg_flashbang"},
