...
bahmut.red = {"ВСРФ",Color(60,75,60),
	weapons = {"weapon_radio","weapon_hands","weapon_rgd5","medkit","weapon_binokle"},
	main_weapon = {"weapon_ak74","weapon_aks74u","weapon_asval"},
...
bahmut.blue = {"ВСУ",Color(125,125,60),
	weapons = {"weapon_radio","weapon_hands","weapon_f1","medkit","weapon_binokle"},
	main_weapon = {"weapon_m4a4","weapon_akm"},
	secondary_weapon = {"weapon_m9","weapon_hk_usps"},
