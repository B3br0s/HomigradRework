...
riot.red = {"Полиция",Color(55,55,150),
	weapons = {"weapon_hands","weapon_pbat","weapon_taser","weapon_radio","weapon_handcuffs"},
	main_weapon = {"weapon_per4ik","med_ifak","med_ibuprofen","weapon_per4ik"},
...
riot.blue = {"Бунтующие",Color(75,45,45),
	weapons = {"weapon_hands","med_bandagesmall"},
	main_weapon = {"weapon_hammer","med_bandagebig","med_bandagesmall","weapon_molotov","weapon_per4ik","weapon_hg_beartrap","weapon_hammer","weapon_axe","weapon_per4ik"},
