...
hook.Add("HUDPaint","homigrad-roundstate",function()
	draw.SimpleText("HG:R","HomigradFont",10,ScrH()-10,Color(255,255,255,50),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
	if roundActive then
		if roundActiveName == "swat" then
			...
			elseif roundActiveName == "zombieinfection" and not LocalPlayer():Alive() and LocalPlayer():Team() == 1 then
