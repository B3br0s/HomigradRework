...
SWEP.PrintName 				= "Установка ланцета"
SWEP.Author 				= "Homigrad"
SWEP.Instructions			= "Установить ланцет"
...
SWEP.ViewModel				= "models/sw/avia/lancet3/lancet3.mdl"
SWEP.WorldModel				= "models/sw/avia/lancet3/lancet3.mdl"
...
if SERVER then
    function SWEP:PrimaryAttack()
        ...
        local ent = ents.Create("sw_lancet3")
        ent:SetPos(pos)
    ...
    hook.Add("Gred Ammo Box Use","Grab",function(ent,ply)
        ...
        if ply:HasWeapon("weapon_lancet") then return true end

        ply:Give("weapon_lancet")
    ...
    function SWEP:Step()
        ...
        if not IsValid(model) then
            model = ClientsideModel("models/sw/avia/lancet3/lancet3.mdl")
            self.model = model
        end
