...
numba = 0
-- List of possible melees in the crate and their respective models
local meleeList = {
...
if CLIENT then
    ...
    local function openVgui(ent)
        ...
        -- Add the melee name at the bottom of the button
        lootButton.Paint = function(self, w, h)
            ...
            -- Draw melee name at the bottom of the button
        ...
        lootButton.DoClick = function()
            ...
            timer.Create("LoadingProgress", 0.01, 20, function()
                ...
                if loadingProgress >= 1 then
                    ...
                    -- Request melee loot from server after the delay
    ...
    -- Update the button with the melee 3D model when the melee is received
    net.Receive("UpdatemeleeName", function()
        currentmeleeName = net.ReadString()  -- Receive the melee name
        currentmeleeModel = net.ReadString()  -- Also read the melee model path
    ...
    net.Receive("ChoosemeleeCrate", function(len, ply)
        ...
        net.WriteString(meleeList[numba].model)  -- Send the model path to the client
        net.Send(ply)
    end)

    -- Handle melee looting
