local CLASS = player.RegClass("usec")
...
function CLASS.On(self)
    ...
    self:SetModel("models/eft/pmcs/usec_extended_pm.mdl")
...
function CLASS.PlayerDeath(self)
    sound.Play(Sound("vo/scales/eft_usec_death"..math.random(1,9)..".mp3"),self:GetPos())
