local CLASS = player.RegClass("dozer")

CLASS.weapons = {"weapon_radio","weapon_police_bat","weapon_handcuffs","weapon_taser"}
CLASS.main_weapon = {"weapon_m249"}
CLASS.secondary_weapon = {"weapon_p220"}
CLASS.models = {"models/monolithservers/mpd/male_02.mdl"}
...
function CLASS:On()
	...
	JMod.EZ_Equip_Armor(self,"Ultra-Heavy-Helmet",color)
	JMod.EZ_Equip_Armor(self,"Heavy-Vest",color)
	JMod.EZ_Equip_Armor(self,"Heavy-Left-Shoulder",color)
	JMod.EZ_Equip_Armor(self,"Heavy-Right-Shoulder",color)
	JMod.EZ_Equip_Armor(self,"Heavy-Right-Thigh",color)
	JMod.EZ_Equip_Armor(self,"Heavy-Left-Thigh",color)
	JMod.EZ_Equip_Armor(self,"Pelvis-Panel",color)
	JMod.EZ_Equip_Armor(self,"Left-Calf",color)
	JMod.EZ_Equip_Armor(self,"Right-Calf",color)
	JMod.EZ_Equip_Armor(self,"Left-Forearm",color)
	JMod.EZ_Equip_Armor(self,"Right-Forearm",color)
