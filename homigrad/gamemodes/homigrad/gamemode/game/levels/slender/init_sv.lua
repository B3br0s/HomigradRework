...
function stopitslender.PlayerSpawn(ply,teamID)
	...
	if teamID == 2 then
		ply:SetPlayerColor(Color(math.random(255),math.random(2555),math.random(255)):ToVector())
    end
	ply.allowFlashlights = true
end

function stopitslender.PlayerInitialSpawn(ply) ply:SetTeam(2) end
