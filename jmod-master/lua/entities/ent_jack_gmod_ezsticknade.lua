...
if SERVER then
	...
	function ENT:Detonate()
		...
		if self.Splitterring then
			...
			JMod.FragSplosion(self, SelfPos + Vector(0, 0, 1), 3000, 70, 5000, JMod.GetEZowner(self))
			self:Remove()
		else
...
elseif CLIENT then
	language.Add("ent_jack_gmod_ezsticknade", "Stick Nade")
end
