...
if SERVER then
	...
	function ENT:Detonate()
			...
			timer.Simple(0, function()
				if IsValid(self) then
					...
					if self.Splitterring then
						...
						JMod.FragSplosion(self, SelfPos + Vector(0, 0, 1), 5000, 70, 5000, JMod.GetEZowner(self))
		...
		JMod.Sploom(Att, SelfPos, 350)
		JMod.Sploom(Att, SelfPos, 350)
		JMod.Sploom(Att, SelfPos, 350)
		JMod.Sploom(Att, SelfPos, 350)
		---
		util.ScreenShake(SelfPos, 1700, 3, 2, 4000)
		...
		util.BlastDamage(game.GetWorld(), Att, SelfPos + Vector(0, 0, 300), 900, 230)
		util.BlastDamage(game.GetWorld(), Att, SelfPos + Vector(0, 0, 300), 800, 330)
		util.BlastDamage(game.GetWorld(), Att, SelfPos + Vector(0, 0, 300), 900, 430)

		timer.Simple(.25, function()
			util.BlastDamage(game.GetWorld(), Att, SelfPos, 1600, 120)
			util.BlastDamage(game.GetWorld(), Att, SelfPos, 1700, 220)
			util.BlastDamage(game.GetWorld(), Att, SelfPos, 1800, 320)
			util.BlastDamage(game.GetWorld(), Att, SelfPos, 1900, 420)
		end)
...
elseif CLIENT then
	...
	language.Add("ent_jack_gmod_ezbomb", "Bomb")
end
