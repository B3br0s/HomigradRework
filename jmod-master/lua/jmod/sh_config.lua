...
JMod.Config.General = {AltFunctionKey = IN_WALK}
JMod.Config.Machines = {Blackhole = nil}
JMod.Config.Weapons = {SwayMult = 0}
JMod.Config.QoL = {
...
JMod.Config.ResourceEconomy = {MaxResourceMult = 0}
