...
SWEP.WorldModel = "models/weapons/w_snowball_thrown.mdl"
SWEP.ViewModel =  "models/weapons/w_snowball_thrown.mdl"
...
SWEP.HitFleshSound = {"hit.wav"}
SWEP.HitSound = {"hit.wav"}
