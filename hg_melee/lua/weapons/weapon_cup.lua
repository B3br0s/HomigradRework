...
SWEP.ViewModel =  "models/props_junk/garbage_coffeemug001a.mdl"
...
SWEP.HitFleshSound = {"physics/glass/glass_impact_bullet1.wav","physics/glass/glass_impact_bullet2.wav","physics/glass/glass_impact_bullet3.wav"}
SWEP.HitSound = {"physics/glass/glass_impact_bullet1.wav","physics/glass/glass_impact_bullet2.wav","physics/glass/glass_impact_bullet3.wav"}
    ...
    if tr.Hit and tr.HitPos:Distance(ply:GetPos()) < 100 then
        if SERVER then
            if tr.Entity:IsPlayer() or tr.Entity:IsNPC() or tr.Entity:GetClass() == "prop_ragdoll" then
                ...
                prop:SetModel("models/props_junk/garbage_coffeemug001a_chunk02.mdl")
                prop:SetPos(tr.HitPos)
                prop:Spawn()
                local prop2 = ents.Create("prop_physics")
                prop2:SetModel("models/props_junk/garbage_coffeemug001a_chunk01.mdl")
                prop2:SetPos(tr.HitPos)
                prop2:Spawn()
                local prop3 = ents.Create("prop_physics")
                prop3:SetModel("models/props_junk/garbage_coffeemug001a_chunk03.mdl")
                prop3:SetPos(tr.HitPos)
                prop3:Spawn()
