if engine.ActiveGamemode() == "homigradcom" then
    ...
    SWEP.Primary.Sound = {"sounds_zcity/fn45/close.wav"}
    SWEP.Primary.SuppressedSound = "sounds_zcity/fn45/supressor.wav"
    SWEP.Primary.SoundFar = "sounds_zcity/fn45/dist.wav"
    SWEP.ReloadTime = 2
    SWEP.TwoHands = false
    SWEP.ShootWait = 0.1
