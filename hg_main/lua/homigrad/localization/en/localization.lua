...
l.use_crate_explosives = "Explosives Container"
l.use_crate_medkit = "Medicines Container"

l.use_time_bomb = "Time Bomb"
l.use_fragnade = "Frag Grenade"
l.use_firenade = "Incendiary Grenade"
l.use_sticknade = "Stick Grenade"
l.use_dynam = "Dynamite"
l.use_smokenade = "Smoke Grenade"
l.use_signalnade = "Signal Grenade"
l.use_gasnade = "Poison Gas Grenade"
l.use_teargasnade = "Tear Gas Grenade"
