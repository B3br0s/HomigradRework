...
SWEP.Primary.Sound = {"arccw_go/p250/p250-1.wav", 75, 100, 100}
...
SWEP.ZoomPos = Vector(-1.3, -0.005, 20)
...
SWEP.lengthSub = 25
SWEP.DistSound = "arccw_go/p250/p250-1-distant.wav"
...
SWEP.IconPos = Vector(1.6,110,-7)

SWEP.BoltBone = "v_weapon.p250_slide"
