...
SWEP.PrintName = "SG 556"--ЧТООО SG_KAAP СТАЛ ОРУЖИЕМ????
...
SWEP.Primary.Sound = {"arccw_go/sg556/sg556_01.wav", 85, 100, 100}
...
SWEP.HoldType = "ar2"
SWEP.ZoomPos = Vector(0.1,-0.125,31.5)
SWEP.RHandPos = Vector(-12, -1, 4)
SWEP.LHandPos = Vector(7, -2, -2)
SWEP.attPos = Vector(5, 1, 40)
SWEP.attAng = Angle(-0.3,-0.12,0)
SWEP.TwoHanded = true
SWEP.Spray = {}
for i = 1, 75 do
...
SWEP.lengthSub = 15
SWEP.DistSound = "arccw_go/sg556/sg556-1-distant.wav"
