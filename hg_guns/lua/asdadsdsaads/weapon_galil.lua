...
SWEP.Instructions = "Автоматическая винтовка под калибр 5,56×45 мм\n\nТемп стрельбы 700 выстрелов в минуту\n\nЕсли присмотреться, то можно понять, что прицельным приспособлением лучше не пользоваться..."
