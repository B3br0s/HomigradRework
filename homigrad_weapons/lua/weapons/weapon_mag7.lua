...
SWEP.Sight = true
SWEP.TwoHands = true
SWEP.MagOut = "csgo/weapons/mag7/mag7_clipout.wav"
SWEP.MagIn = "csgo/weapons/mag7/mag7_clipin.wav"
SWEP.BoltOut = "csgo/weapons/mag7/mag7_pump_back.wav"
SWEP.BoltIn = "csgo/weapons/mag7/mag7_pump_forward.wav"
SWEP.MagOutWait = 0.2
SWEP.MagInWait = 0.9
