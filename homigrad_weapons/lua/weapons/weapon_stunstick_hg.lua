...
SWEP.Instructions = "Дубинка, используемая ГО"
...
self:SetHoldType( "melee" )
self:GetOwner():EmitSound( "weapons/stunstick/spark" .. math.random(1,3) .. ".wav",60 )
end
...
function SWEP:PrimaryAttack()
	...
	if SERVER then
		self:GetOwner():EmitSound( "weapons/stunstick/stunstick_swing" .. math.random(1,2) .. ".wav",60 )
	...
	if true then
		...
		if IsValid( tr.Entity ) and SERVER then
			...
			if tr.Entity:IsNPC() or tr.Entity:IsPlayer() then
				...
				tr.Entity:EmitSound("weapons/stunstick/stunstick_fleshhit" .. math.random(1,2) .. ".wav")
