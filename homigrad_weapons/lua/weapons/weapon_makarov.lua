...
SWEP.ShootWait = 0.12
SWEP.MagOut = "zcitysnd/sound/weapons/makarov/handling/makarov_magout.wav"
SWEP.MagIn = "zcitysnd/sound/weapons/makarov/handling/makarov_maghit.wav"
SWEP.BoltIn = "zcitysnd/sound/weapons/makarov/handling/makarov_boltrelease.wav"
SWEP.MagOutWait = 0.2
SWEP.MagInWait = 1.5
SWEP.BoltInWait = 2
