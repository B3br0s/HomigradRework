...
SWEP.PrintName = "Метательный Ножик"
SWEP.Instructions = "Опасное оружие,не убей себя им."
...
SWEP.ViewModel = "models/weapons/arccw_go/w_eq_throwingknife_thrown.mdl"
	...
	if CLIENT then
		...
		function SWEP:DrawWorldModel()
			...
			if (IsValid(_Owner)) then
				...
				local offsetVec = Vector(3.5,-2,-2)
				local offsetAng = Angle(160, 25, 25)
