    ...
    if LocalPlayer():Alive() and LocalPlayer():GetNWBool("fake") == false then  
        ...
        if LocalPlayer():GetNWBool("InTeam") then
            ...
            leaveframe.Paint = function(self, w, h)
                ...
                draw.SimpleText("Leave team", "HomigradFont", w / 2.5, h / 4, Color(255, 255, 255), TEXT_ALIGN_CENTER)
            end
            ...
            leave.DoClick = function ()
                ...
                LocalPlayer():ChatPrint("You leaved team.")
        ...
        if LocalPlayer():GetNWEntity("InviterToTeam") != NULL then
            ...
            mainframe.Paint = function(self, w, h)
                ...
                draw.SimpleText("Team invite from "..LocalPlayer():GetNWEntity("InviterToTeam"):Name(), "HomigradFontInv", w / 2 - 60, h / 3, Color(255, 255, 255), TEXT_ALIGN_CENTER)
            end
            ...
            accept.DoClick = function ()
                ...
                LocalPlayer():ChatPrint("You accepted an invitation to join the team from "..LocalPlayer():GetNWEntity("InviterToTeam"):Name())
                LocalPlayer():ConCommand("hg_inv")
            end
            ...
            decline.DoClick = function ()
                ...
                net.WriteEntity(LocalPlayer())
                net.SendToServer()
                LocalPlayer():ChatPrint("You declined an invitation to join the team from "..LocalPlayer():GetNWEntity("InviterToTeam"):Name())
                LocalPlayer():ConCommand("hg_inv")
            end
        end
        end
