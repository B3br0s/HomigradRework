...
SWEP.WorldModel = "models/weapons/w_sog_knife.mdl"

SWEP.HoldAng = Angle(0,-50,0)
SWEP.HoldPos = Vector(3,1.1,2.25)
...
SWEP.IconAng = Angle(180,0,-90)
SWEP.IconPos = Vector(43,1,1.25)