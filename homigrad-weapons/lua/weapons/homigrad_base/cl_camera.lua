...
function SWEP:Camera(ply, origin, angles, fov)
	...
	local zalupa = math.AngleDifference(MAMA_KSILANA_SHLUHA[2],ang[2])
	local zalupa2 = math.AngleDifference(MAMA_KSILANA_SHLUHA[1],ang[1])
