...
function ENT:PlayFadeinSound()
	...
	if category == "EF0" or category == "EF1" or category == "EF2"then
		...
		CreateSoundWave("streams/environment/wind_shared/ef0_fadein.mp3", self:GetPos(), "mono", 340/2, {80,120}, 10)
		
	elseif category == "EF3" then
	
		CreateSoundWave("streams/environment/wind_shared/ef3_fadein.mp3", self:GetPos(), "mono", 340/2, {80,120}, 10)

	elseif category == "EF4" then
	
		CreateSoundWave("streams/environment/wind_shared/ef4_fadein.mp3", self:GetPos(), "mono", 340/2, {80,120}, 10)
